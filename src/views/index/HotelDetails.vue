<template>
    <div class="hoteldetails">
        <div class="swipe-body">
            <van-swipe >
                <van-swipe-item><img src="../../assets/hotel.png" alt="" class="swipe-img"></van-swipe-item>
                <van-swipe-item><img src="../../assets/hotel.png" alt="" class="swipe-img"></van-swipe-item>
                <van-swipe-item><img src="../../assets/hotel.png" alt="" class="swipe-img"></van-swipe-item>
                <van-swipe-item><img src="../../assets/hotel.png" alt="" class="swipe-img"></van-swipe-item>
                <template #indicator>
        ...
        <div class="hotel-body">
            <div class="hotel-title">
                <div class="hotel-title-left">
                    <span  class="hotel-title-name">xxx</span>
            ...
            <div class="hotel-address">
                <div class="hotel-address-detail">
                    ...
                    <span class="hotel-address-text">xxx</span>
                </div>
            ...
            <div class="hotel-detail">
                <div class="hotel-detail-header">
                    <div class="hotel-detail-header-date">
                        <div class="hotel-detail-header-datebox">ffff</div>
                        <div class="hotel-detail-header-datebox">ffff</div>
                        <div class="hotel-detail-header-datebox">ffff</div>
                    </div>
