<template>
    <div class="app">
        <div class="login-body">
            ...
            <login-lo  :isShow="loginshow"></login-lo>
            <login-re  :isShow="registershow"></login-re>
        </div>
        <div class="bottom">
            ...
            <div class="bottom-icon">
                <img src="../../assets/imgs/weixin.png" alt="" class="bottom-icon-size">
                <img src="../../assets/imgs/QQ.png" alt="" class="bottom-icon-size">
                <img src="../../assets/imgs/weibo.png" alt="" class="bottom-icon-size">
            </div>
        </div>
...
<script>
    ...
    import LoginLo from "../../views/loginbody/LoginLo"
    import LoginRe from "../../views/loginbody/LoginRe"
    export default {
        name:"Login",
        data(){
            return{
...
<style scoped>
    .app{
        position: relative;
        background: url("../../assets/imgs/body.png") 0 0 no-repeat;
        background-size: 100%;
        padding: 10px 0;
    }
    .login-body{
        ...
        border-radius: 10px;
        background: #ffffff;;
        box-shadow: 0 0 1px rgb(176, 177, 177);
        padding: 70px 0;
